...
Run: Save the code as main.py and execute:
...
Ideas for Contribution: Add a timer, implement difficulty levels, or use a different gesture (like a closed fist) for the hit action.
